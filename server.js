...
//   try {
//     const ssl = await devcert.certificateFor("localhost"); // Adjust hostname if needed

//     // Create HTTPS server with certificates
//     const httpsServer = https.createServer(ssl, app);

//     // WebSocket server setup (no changes needed here)
...
//     );
//   } catch (error) {
//     console.error("Error generating devcert:", error);
//   }
// }
